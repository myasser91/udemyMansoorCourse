...
class NewArchivedScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return  BlocConsumer<Appcubit, Appstates>(
          ...
          builder: (context, state) {if (Appcubit.get(context).NewTasks.length == 0) {
            return Container(
     ...
     return ListView.separated(itemBuilder: (context,index)=>Buildtaskitem(Appcubit.get(context).ArchivedTasks[index],context),
